...
import { Controller, Get, Body, Post, Put, Param, BadRequestException, NotFoundException, HttpCode, Delete } from '@nestjs/common';

@Controller('pets')             // { "name": "Nyan", "animalType": "cat", "preferedFood": [{"Foodname": "Tuna"}]}
